...
const previews = [
  ...
  {
    filename: "admin-friday-branch-class-roster.html",
    html: buildFridayBranchClassRosterEmailHtml({
      schoolName: "Rooted Meadows Waldorf School",
  ...
  {
    filename: "admin-friday-branch-enrollment.html",
    html: buildFridayBranchEnrollmentAdminNotificationHtml({
      schoolName: "Rooted Meadows Waldorf School",
      className: "Nature Journaling",
      slotTime: "9:00 AM",
      blockLabel: "Fall Block",
