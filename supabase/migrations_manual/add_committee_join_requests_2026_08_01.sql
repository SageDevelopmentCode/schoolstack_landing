-- Promoted to supabase/migrations/20260801_add_committee_join_requests.sql for local/CI.
-- Run this file in Supabase SQL Editor on remote if that migration has not been applied.
-- Date: 2026-08-01
-- Purpose: committee_join_requests table + parent portal RLS for committees.
