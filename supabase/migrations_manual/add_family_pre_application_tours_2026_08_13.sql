-- Promoted to supabase/migrations/20260817_add_family_pre_application_tours.sql for local/CI.
-- Run this file in Supabase SQL Editor on remote if that migration has not been applied.
-- Purpose: 2026-08-13 — allow campus tour bookings before an application exists.
