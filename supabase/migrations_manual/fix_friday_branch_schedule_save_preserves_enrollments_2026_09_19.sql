-- Promoted to supabase/migrations/20261005_fix_friday_branch_schedule_save_preserves_enrollments.sql for local/CI.
-- Run this file in Supabase SQL Editor on remote if that migration has not been applied.
-- Date: 2026-09-19 — Fix save_friday_branch_schedule wiping enrollments on every save
