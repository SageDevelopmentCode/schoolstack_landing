-- Consolidate Sep 14–22 dashboard cards after the initial batch paste.
-- Promoted to supabase/migrations/20261024_consolidate_feature_announcements_sep_14_22.sql for local/CI.
-- Run this in Supabase SQL Editor if you already pasted the original Sep 14–22 dashboard cards.
