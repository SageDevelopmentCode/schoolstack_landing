-- Update Rooted Meadows std-2 Withdrawal and Termination text (production org).
-- Date: 2026-08-16
-- Purpose: Align Withdrawal section with RMWS Enrollment Contract JoshEdit PDF.
-- Safe to re-run: updates std-2 body in place; Step B only affects completed standard agreements.
-- Target org: rooted-meadows
--
-- Run Step A first. Run Step B after deploying app re-sign support (or with today's in_progress reset).
...
$std2$;
  ...
  v_standard_template_item_id uuid := 'd2d55304-ed9f-4638-8bf8-0e6339c62ad1';
...
where o.slug = 'rooted-meadows'
  and eci.template_item_id = 'd2d55304-ed9f-4638-8bf8-0e6339c62ad1'
  and eci.responses ? 'pendingResignSectionIds'
