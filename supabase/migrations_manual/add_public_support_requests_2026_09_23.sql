-- Promoted to supabase/migrations/20261025_add_public_support_requests.sql for local/CI.
-- Run this file in Supabase SQL Editor on remote if that migration has not been applied.
-- Purpose: public /support form submissions for MudKitchen marketing site (2026-09-23).
