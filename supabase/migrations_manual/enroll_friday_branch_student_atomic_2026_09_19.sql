-- Promoted to supabase/migrations/20261006_enroll_friday_branch_student_atomic.sql for local/CI.
-- Run this file in Supabase SQL Editor on remote if that migration has not been applied.
-- Date: 2026-09-19 — Atomic Friday Branch enrollment with capacity check under row lock
