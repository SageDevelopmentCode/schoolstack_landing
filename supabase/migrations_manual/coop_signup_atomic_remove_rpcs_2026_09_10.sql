-- Promoted to supabase/migrations/20260918_coop_signup_atomic_remove_rpcs.sql for local/CI.
-- Run this file in Supabase SQL Editor on remote if that migration has not been applied.
-- Run after: coop_family_id_signups_2026_09_10.sql (or 20260917_coop_family_id_signups.sql)
