-- Promoted to supabase/migrations/20260820_add_observation_slots.sql for local/CI.
-- Run this file in Supabase SQL Editor on remote if that migration has not been applied.
-- Shadow day observation slots (grade/time flexibility) — 2026-08-14
...
drop policy if exists "Platform admins manage admissions_observation_slots" on public.admissions_observation_slots;
...
drop policy if exists "Org members can read admissions_observation_slots" on public.admissions_observation_slots;
...
drop policy if exists "Org admins can insert admissions_observation_slots" on public.admissions_observation_slots;
...
drop policy if exists "Org admins can update admissions_observation_slots" on public.admissions_observation_slots;
...
drop policy if exists "Org admins can delete admissions_observation_slots" on public.admissions_observation_slots;
...
drop policy if exists "Platform admins manage admissions_observation_slot_grades" on public.admissions_observation_slot_grades;
...
drop policy if exists "Org members can read admissions_observation_slot_grades" on public.admissions_observation_slot_grades;
...
drop policy if exists "Org admins manage admissions_observation_slot_grades" on public.admissions_observation_slot_grades;
