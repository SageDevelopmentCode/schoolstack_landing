...
-- Run in Supabase SQL Editor before using the unread badge in the admin sidebar.
--
-- Unread count = activity_events in the notification allowlist + 30-day window
-- where created_at > last_read_at for (user_id, organization_id).
