-- Enrollment enroll-complete timestamp for tuition billing start.
-- Run after: 20260923_classroom_signup_multiselect_audience.sql
...
-- Backfill from enrollment.completed activity events.
...
-- Fallback for enrolled rows without a completion event.
