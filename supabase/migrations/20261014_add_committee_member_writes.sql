-- Committee member writes: creator attribution + parent member RLS.
...
-- Members may update any task (status changes on the board); UI limits full edits to own tasks.
