...
export default function HeroSection() {
  return (
    <section className="pt-[140px] pb-[120px] md:pt-[140px] md:pb-[120px] bg-bg overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[45fr_55fr] gap-12 lg:gap-16 items-center">
          ...
          <div>
            <motion.div initial="hidden" animate="visible" variants={makeVariant(0)}>
              <span className="inline-flex items-center gap-1.5 rounded-pill bg-accent-soft text-accent text-[11px] font-medium uppercase tracking-widest px-3 py-1.5">
            ...
            <motion.h1
              ...
              className="font-display text-[clamp(2.75rem,5.5vw,5.25rem)] leading-[0.96] tracking-tight text-text mt-6"
            >
            ...
            <motion.p
              ...
              className="text-[17px] md:text-[18px] text-text-muted leading-relaxed max-w-[52ch] mt-6"
            >
              School Stack started at Sage Field in Texas after trying to run
              enrollment, billing, parent communication, contracts, and daily
              operations across too many disconnected tools. Now it gives other
              microschools one calm system to run the whole school.
            </motion.p>
            ...
            >
              <a
                href="#demo"
                className="inline-flex items-center gap-2 bg-accent text-white text-sm font-medium rounded-pill px-6 h-11 hover:bg-accent-hover hover:-translate-y-0.5 transition-all duration-200 shadow-xs"
              >
                Book a Demo
          ...
          <motion.div
            ...
            className="w-full h-[420px] md:h-[500px] lg:h-[540px] rounded-xl bg-surface border border-border shadow-lg overflow-hidden"
          >
            <HeroProductMockup />
          </motion.div>
