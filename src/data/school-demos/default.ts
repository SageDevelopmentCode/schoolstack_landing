...
export const defaultWebsiteDemoConfig: SchoolWebsiteDemoConfig = {
  ...
  hero: {
    ...
    backgroundImage: "/images/stock/ImageOne.jpg",
    floatingImages: ["/images/stock/Homeschool2.jpg", "/images/stock/ImageThree.jpg"],
  ...
  welcome: {
    ...
    mainImage: "/images/stock/ImageThree.jpg",
  ...
  form: {
    ...
    sidebarImage: "/images/stock/ImageThree.jpg",
