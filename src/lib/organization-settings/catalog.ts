...
export const FEATURE_CATALOG: FeatureDef[] = [
  ...
  { portal: "admin", key: "bulletin", label: "Bulletin", description: "Announcements and flyers for families and staff" },
  ...
  { portal: "teacher", key: "classroom_signups", label: "Classroom signups", description: "Parent volunteer signups for classroom events" },
  { portal: "teacher", key: "forms_documents", label: "Forms", description: "Family forms for classroom signatures" },
