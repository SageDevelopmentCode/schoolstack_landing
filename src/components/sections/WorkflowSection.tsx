...
import {
  MonitorPlay, Globe, CalendarCheck, Sparkles, Layers,
...
const STEPS: Step[] = [
  {
    ...
    shortTitle: 'Tour',
    body: 'See real screens, real workflows, and real schools running on MudKitchen. No signup, no fluff — just what it looks like in action.',
    cta: 'Watch the Tour',
  ...
  },
  {
    number: '02',
    icon: Globe,
    title: 'See your school live in minutes',
    shortTitle: 'Website',
    body: 'Drop in your school name, pick a layout, and watch a fully-branded school website appear. No account, no commitment.',
    cta: 'Try the Website Builder',
    footnote: 'Free — no account needed',
    href: '#',
  },
  {
    number: '03',
    icon: CalendarCheck,
    title: 'See it running your actual workflows',
    shortTitle: 'Demo',
    body: 'Walk through enrollment, parent communication, billing, and staff tools with the founder who built it to run a real school.',
  ...
  },
  {
    number: '04',
    icon: Sparkles,
    title: 'Run your school free for 30 days',
    shortTitle: 'Trial',
    body: 'Bring your actual families, staff, and workflows. Full software access — every feature, your real data, your real team.',
  ...
  },
  {
    number: '05',
    icon: Layers,
    title: 'Pick your plan and go live',
    shortTitle: 'Pricing',
    body: "Choose the stack that fits your school size today. We set up everything with you and stay on until it's running smoothly.",
    cta: 'View Pricing',
...
const STEP_PREVIEWS = [
  /* 01 — Tour */
  <div key="tour" className="flex flex-col items-center justify-center gap-4 w-full px-8 py-10">
    <div
      className="w-16 h-16 rounded-full flex items-center justify-center"
      style={{ backgroundColor: 'rgba(160,92,69,0.25)', border: '1px solid rgba(160,92,69,0.4)' }}
    >
      <Play size={24} style={{ color: '#E8D5C8' }} fill="#E8D5C8" />
    </div>
    <div className="w-full max-w-[280px] space-y-2">
      <div className="h-1.5 rounded-full bg-white/10 overflow-hidden">
        <div className="h-full w-[35%] rounded-full" style={{ backgroundColor: '#A05C45' }} />
      </div>
      <div className="flex justify-between">
        <span className="text-[11px] font-mono" style={{ color: 'rgba(247,241,231,0.3)' }}>0:48</span>
        <span className="text-[11px] font-mono" style={{ color: 'rgba(247,241,231,0.3)' }}>2:14</span>
      </div>
    </div>
    <p className="text-[12px] text-center" style={{ color: 'rgba(247,241,231,0.35)' }}>
      Product tour · 2 min 14 sec
    </p>
  </div>,

  /* 02 — Website builder */
  <div key="website" className="flex items-center justify-center w-full p-6">
    <div
    ...
    >
      ...
      >
        ...
        >
          <span className="text-[10px]" style={{ color: 'rgba(247,241,231,0.3)' }}>
            yourschool.mudkitchen.com
          </span>
        </div>
      </div>
      <div className="p-3 space-y-2" style={{ backgroundColor: 'rgba(0,0,0,0.2)' }}>
        <div className="h-8 rounded-md w-full" style={{ backgroundColor: 'rgba(255,255,255,0.05)' }} />
        <div className="h-16 rounded-md w-full" style={{ backgroundColor: 'rgba(255,255,255,0.03)' }} />
        <div className="grid grid-cols-3 gap-2">
          <div className="h-10 rounded-md" style={{ backgroundColor: 'rgba(255,255,255,0.05)' }} />
          <div className="h-10 rounded-md" style={{ backgroundColor: 'rgba(255,255,255,0.05)' }} />
          <div className="h-10 rounded-md" style={{ backgroundColor: 'rgba(255,255,255,0.05)' }} />
        </div>
      </div>
        ...
        {CALENDAR_DATES.map(d => (
          <button
            ...
            style={{
              ...
              color: CALENDAR_AVAILABLE.includes(d) ? '#E8D5C8' : 'rgba(247,241,231,0.4)',
  ...
  <div key="trial" className="flex items-center justify-center w-full p-8">
    <div className="w-full max-w-[360px]">
      <p
        ...
        style={{ color: 'rgba(247,241,231,0.4)' }}
      >
        Everything included · 30 days free
      </p>
    ...
    <div className="flex gap-3 w-full max-w-[460px]">
      {PRICING_PLANS.map(p => (
        <div
          ...
          style={{
            backgroundColor: p.featured ? 'rgba(160,92,69,0.15)' : 'rgba(255,255,255,0.04)',
            border: p.featured
        ...
        >
          ...
          <span className="font-display font-medium" style={{ color: '#F7F1E7', fontSize: '1.4rem' }}>
            {p.price}
            <span className="text-[12px] opacity-50">/mo</span>
          </span>
          <span className="text-[11px] font-secondary" style={{ color: 'rgba(247,241,231,0.4)' }}>
            {p.note}
          </span>
        </div>
      ))}
        ...
        <div className="text-center max-w-[560px] mx-auto">
          ...
          <FadeInView delay={0.08}>
            ...
            >
              ...
              <br />
              <em style={{ color: '#E8D5C8', fontStyle: 'italic' }}>Five steps, no friction.</em>
            </h2>
          </FadeInView>
          <FadeInView delay={0.14}>
            <p className="text-[16px] leading-relaxed mt-4" style={{ color: 'rgba(247,241,231,0.60)' }}>
              Each step is designed to give you more confidence, not ask more of you.
            </p>
          </FadeInView>
        </div>
        ...
        <div className="mt-16 flex flex-col lg:flex-row gap-3 lg:gap-8 lg:items-start">
          ...
          <div className="hidden lg:block w-[260px] shrink-0 relative">
            <div
              ...
              style={{ left: '27px', borderLeft: '1px dashed rgba(247,241,231,0.12)' }}
              aria-hidden="true"
            />
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mt-6 flex items-center gap-4 flex-wrap">
                  ...
                  <span className="text-[12px]" style={{ color: 'rgba(247,241,231,0.35)' }}>
