    ...
    return (
      <PortalCard className="text-center">
        <div
          ...
          style={{ backgroundColor: T.stepBg, color: T.accent }}
        >
        ...
        <button
          ...
          className="font-secondary mt-6 rounded-full px-5 py-2.5 text-[13px] font-semibold text-white"
  ...
  return (
    <div>
      <button
        ...
        className="flex w-full items-center justify-between gap-4 rounded-2xl border px-6 py-5 text-left transition-colors sm:px-7"
        style={{
          backgroundColor: T.surface,
      ...
      >
        <div>
          <p
            className="font-heading text-[1.15rem] font-medium sm:text-[1.25rem]"
            style={{ color: T.textPrimary }}
          >
            Send a message
          </p>
              ...
              <PortalCard>
                      ...
                      >
                        ...
                        {attachments.length < MAX_FILES ? (
                          <button
                            ...
                            disabled={submitting}
                            className="font-secondary mt-3 rounded-full border px-3 py-2 text-sm font-semibold"
                            style={{
                              borderColor: T.border,
                              backgroundColor: T.surface,
                              color: T.textPrimary,
                ...
                <div className="mt-6 flex justify-end">
                  <button
                    type="submit"
                    disabled={!canSubmit}
                    className="font-secondary flex items-center gap-1.5 rounded-full px-5 py-2.5 text-[13px] font-semibold text-white disabled:opacity-50"
                    style={{
