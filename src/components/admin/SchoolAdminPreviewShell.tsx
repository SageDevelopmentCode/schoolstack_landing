...
type SchoolAdminPreviewShellProps = {
  schoolName: string;
...
export default function SchoolAdminPreviewShell({
  schoolName,
  userProfile,
  familyId,
  children,
}: SchoolAdminPreviewShellProps) {
  return (
          ...
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold text-violet-900">
                Previewing school admin as {userProfile.displayName}
              ...
              <p className="mt-0.5 truncate text-xs text-violet-800/80">
                ...
                {familyId ? " · dual-access owner preview" : ""}
              </p>
            </div>
          </div>
