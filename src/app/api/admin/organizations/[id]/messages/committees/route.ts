...
import { listOrganizationCommitteeMessageSummaries } from "@/lib/admin/organization-committee-messages";
...
const ROUTE = "/api/admin/organizations/[id]/messages/committees";
...
export async function GET(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const committees = await listOrganizationCommitteeMessageSummaries(
      admin,
      organizationId,
    );
