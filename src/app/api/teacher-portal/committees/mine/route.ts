...
import { listTeacherCommitteeMemberships } from "@/lib/committees/teacher-committees";
import {
...
const ROUTE = "/api/teacher-portal/committees/mine";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const committees = await listTeacherCommitteeMemberships(
      admin,
      organizationId,
      user.id,
    );
