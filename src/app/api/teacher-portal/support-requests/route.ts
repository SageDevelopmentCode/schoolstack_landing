...
export async function POST(request: Request) {
  ...
  const hasTeacherAccess = await userHasTeacherPortalAccess(
    supabase,
    user.id,
    organizationId,
  );
  ...
  try {
    ...
    void logNotificationFailure(admin, {
      organizationId: organization.id,
      operation: "teacher_portal_support_request_discord",
      error: err,
      entityType: "admin_support_request",
      entityId: requestId,
    });
  ...
  try {
    ...
    void logNotificationFailure(admin, {
      organizationId: organization.id,
      operation: "teacher_portal_support_request_confirmation_email",
      error: err,
      entityType: "admin_support_request",
      entityId: requestId,
    });
