export type School = {
  ...
  confidence: string
  isClosing?: boolean
  sourceFile: 'texas' | 'expanded'
}

export const schools: School[] = [
  // ─── CSV 1 — Texas Microschools ────────────────────────────────────────────
  {
    id: 'ahb-community-school',
    name: 'AHB Community School',
    state: 'TX',
    location: 'Austin, TX',
    website: 'https://www.ahbcs.org',
    schoolModel: 'Private non-religious micro school / progressive, project-based',
    grades: 'K–8',
    estimatedSize: '~80–100 students',
    tuitionSchedule: '~$13,900/year; Mon–Thu 9am–2:30pm + optional Friday Extension (~$2,300)',
    strengths: [
    ...
    softwareFitReason:
      'Strong fit: combines small size, parent partnership, nontraditional reporting, optional care/Friday programs, and frequent class-level communication needs. A centralized platform could simplify enrollment, calendars, updates, and family engagement.',
    priorityScore: 4,
    confidence: 'High',
    sourceFile: 'texas',
  },
  {
    id: 'austin-micro-school',
    name: 'Austin Micro School',
    state: 'TX',
    location: 'Manchaca (south Austin), TX',
    website: 'https://www.austinmicroschool.org',
    schoolModel: 'Private microschool — First Principles, Montessori-inspired, hands-on, project-based; full-time and hybrid options',
    grades: 'K–9 (expanding)',
    estimatedSize: 'Small by design; max 12:1 ratio',
    tuitionSchedule: 'Full-time $500/week or $18,000/year; Hybrid from $139/week; 30-day tryout offered',
    strengths: [
  ...
  {
    id: 'inspired-learning-academy',
    name: 'Inspired Learning Academy',
    state: 'TX',
    location: 'Allen, TX',
    website: 'https://www.inspiredlearningacademy.org',
    schoolModel: 'Private microschool / hybrid learning program / homeschool umbrella school with self-directed learning and mentorship',
    grades: '6–12',
    estimatedSize: '~22 students; 4:1 student-teacher ratio',
    tuitionSchedule: '~$8,470/year; Tue–Thu on campus, Mon/Fri remote; 9am–3:45pm',
    strengths: [
  ...
  {
    id: 'esteam-academy-round-rock',
    name: 'ESTEAM Academy Round Rock',
    state: 'TX',
    location: 'Round Rock, TX',
    website: 'https://esteamacademyrr.com',
    schoolModel: 'Acton Academy affiliate — learner-driven microschool, self-paced, mastery-based, mixed-age, project-based',
    grades: 'Ages 4–18 (PreK–HS); no traditional grade levels',
    estimatedSize: '~54–55 students; max capacity 70',
    tuitionSchedule: '1–5 day options: $4,510–$13,700/year; remote learners $7,500/year; 9am–4pm',
    strengths: [
  ...
  {
    id: 'apogee-dripping-springs',
    name: 'Apogee Dripping Springs',
    state: 'TX',
    location: 'Dripping Springs, TX',
    website: 'https://www.apogeedrippingsprings.com',
    schoolModel: 'Micro high school — mixed-age, project-based, life skills, character development, community-based learning',
    grades: '9–12',
    estimatedSize: 'Very small (3–14 students); closing after graduating class',
    tuitionSchedule: 'Tuition not publicly listed; M–F ~8:30am–3:30pm',
    strengths: [
  ...
  {
    id: 'natures-schoolhouse-microschool',
    name: "Nature's Schoolhouse Microschool",
    state: 'TX',
    location: 'Cedar Park, TX',
    website: 'https://www.naturesschoolhouse.com',
    schoolModel: 'Secular, nature-based, progressive/constructivist microschool with hybrid homeschool feel; drop-off program plus enrichment and teen learning lounge',
    grades: 'PK–6 core; 7–12 Teen Learning Lounge',
    estimatedSize: '~15–20 students in core program',
    tuitionSchedule: 'Annual tuition; Tue–Thu 9am–2pm; Mon Discovery Days 9am–3:30pm; Sept–May',
    strengths: [
  ...
  {
    id: 'the-woodlands-microschool',
    name: 'The Woodlands Microschool',
    state: 'TX',
    location: 'Conroe, TX',
    website: 'https://thewoodlandsmicroschool.com',
    schoolModel: 'Accredited private microschool / hybrid private school; elementary, junior high, high school, homeschool classes, tutoring, and credit recovery',
    grades: 'Elementary (4th–8th) through High School',
    estimatedSize: 'Small; class sizes not publicly stated',
    tuitionSchedule: '$13,500/year including enrollment fee; 4-day week, 4-hour day; M–F office hours 9am–3pm',
    strengths: [
  ...
  },
  {
    ...
    state: 'TX',
    location: 'Katy, TX',
    website: 'https://www.mirus-academy.org',
    schoolModel: 'Independent, secular private micro-school / college-prep high school',
    grades: '8–12 (min age 13 by Sept 1)',
    estimatedSize: '~25 students; ~6–8 per class',
    tuitionSchedule: '$13,500–$18,250/year; Mon–Thu 9am–3:15pm + 2 Fridays/month; early arrival from 7:45am',
    strengths: [
  ...
  {
    id: 'katy-houston-life-stem-academy',
    name: 'Katy/Houston LIFE STEM Academy',
    state: 'TX',
    location: 'Katy, TX',
    website: 'https://learningforexcellence.com/katyhomeschool/',
    schoolModel: 'Two-day-per-week hybrid homeschool academy with online support and in-person classes; STEM focus with dual-credit pathways',
    grades: '6–12',
    estimatedSize: 'Cap of 24 students',
    tuitionSchedule: '$12,000/year; Tue & Thu 9:30am–3:30pm; rolling admissions',
    strengths: [
  ...
  {
    id: 'brighter-futures-microschool',
    name: 'Brighter Futures Microschool',
    state: 'TX',
    location: 'Arlington, TX',
    website: 'https://www.brighterfuturesedtherapy.com',
    schoolModel: 'Microschool / part-time university model with individualized educational therapy and small-group instruction for students with learning, language, and social differences',
    grades: 'K–6 (elementary)',
    estimatedSize: 'Groups of 3–5 students based on skill needs',
    tuitionSchedule: 'No public tuition; 3 days/week, 3 hours each day',
    strengths: [
  ...
  {
    id: 'spyrja-academy',
    name: 'Spyrja Academy of New Braunfels',
    state: 'TX',
    location: 'New Braunfels, TX',
    website: 'https://sanewbraunfels.org',
    schoolModel: 'Private microschool / alternative school with blended, multimodal, individualized instruction; career and trade-oriented pathways',
    grades: '6–12 (primarily 9–12)',
    estimatedSize: 'Ideal size of ~40 students; current enrollment not published',
    tuitionSchedule: 'Tuition not published; 2–5 day schedule options; Fridays for community service/tutoring/labs',
    strengths: [
  ...
  {
    id: 'hill-country-micro-school',
    name: 'Hill Country Micro-School',
    state: 'TX',
    location: 'Kerrville, TX',
    website: 'https://www.hillcountrymicroschool.com',
    schoolModel: 'Private microschool / small mixed-grade learning community with individualized curriculum and exploratory, creative instruction',
    grades: 'K–8',
    estimatedSize: 'Small; exact enrollment not published',
    tuitionSchedule: 'Tuition and schedule not publicly listed',
    strengths: [
  ...
  {
    id: 'the-kinder-haus',
    name: 'The Kinder Haus Microschool',
    state: 'TX',
    location: 'New Braunfels, TX',
    website: 'https://www.thekinderhaus.com/p/about.html',
    schoolModel: 'Faith-based non-traditional kindergarten microschool / homeschool hybrid; 2 days in class + 2 teacher-provided at-home days + optional 5th STEM enrichment day',
    grades: 'Kindergarten (optional enrichment K–8)',
    estimatedSize: 'Max 12 students',
    tuitionSchedule: 'Tuition not published; 2+2 hybrid schedule + optional STEAM Schoolhouse day',
    strengths: [
  ...
  {
    id: 'book-hooks-schoolhouse',
    name: 'The Book Hooks Schoolhouse',
    state: 'TX',
    location: 'Houston, TX',
    website: 'https://bookhooklearning.com',
    schoolModel: 'Christian hybrid microschool / homeschool partnership; 2 on-site days + 3 individualized at-home days',
    grades: '1–12',
    estimatedSize: 'Not publicly disclosed',
    tuitionSchedule: 'Tuition not listed; Mon/Wed (elem/jr high) or Tue/Thu (jr high/HS) 9am–3pm on-site',
    strengths: [
  ...
  },
  {
    ...
    website: 'https://www.launchacademy.info',
    schoolModel: 'Special education / inclusion microschool for neurodiverse students; individualized and small-group instruction with integrated life, social, and vocational skills support',
    grades: '3–12',
    estimatedSize: 'Max 30 students; 5:1 (or 3:1) student-teacher ratio',
    tuitionSchedule: '$22,000/year; $2,000 non-refundable deposit; M–F 8:30am–3:30pm (extended Tue/Thu until 4:30pm)',
    strengths: [
  ...
  },
  {
    ...
    schoolModel: 'Private microschool and homeschool hybrid; also offers preschool/Pre-K, camps, and enrichment classes',
    grades: 'Pre-K 3 – 8th grade',
    estimatedSize: '50+ families',
    tuitionSchedule: 'Not publicly listed; flexible 2–5 day options; 8:30am–3:30pm school hours',
    strengths: [
  ...
  {
    id: 'bright-minds-future-leaders',
    name: 'Bright Minds Future Leaders',
    state: 'TX',
    location: 'New Caney, TX',
    website: 'https://brightmindsfutureleaders.com',
    schoolModel: 'Private microschool / private elementary school with ability-based, mixed-age learning and personalized instruction',
    grades: 'K–5 (possibly K–8)',
    estimatedSize: 'Max 8–12 students; 12:1 max ratio',
    tuitionSchedule: 'Tuition described as affordable but not published; Mon–Thu 8:30am–3:30pm + Friday enrichment',
    strengths: [
  ...
  {
    id: 'athena-micro-academy-austin',
    name: 'Athena Micro-Academy of Austin',
    state: 'TX',
    location: 'South Austin, TX',
    website: 'https://www.amaustin.org',
    schoolModel: 'Relationship-centered microschool / hybrid, self-directed learning model with personalized coaching, enrichment, and year-round programming',
    grades: '6–11 (12th considered case-by-case); launching Fall 2026',
    estimatedSize: '10–12 students per learning coach (launch stage)',
    tuitionSchedule: 'Year-round; annual tuition with monthly/semester/lump-sum options; exact amounts not publicly listed',
    strengths: [
  ...
  {
    id: 'primer-potranco',
    name: 'Primer Microschools — Potranco',
    state: 'TX',
    location: 'San Antonio, TX',
    website: 'https://primer.com/schools/potranco-tx',
    schoolModel: 'Teacher-led K–8 microschool with mixed-age classrooms, project-based learning, and a foundations-first approach; part of the Primer network',
    grades: 'K–8',
    estimatedSize: 'Small early-stage campus; 3–6 mixed-age classrooms typical',
    tuitionSchedule: 'Free for TX students via Texas Education Freedom Accounts; small after-school program cost; opening Aug 2026',
    strengths: [
  ...
  {
    id: 'acton-houston-heights',
    name: 'Acton Academy Houston Heights',
    state: 'TX',
    location: 'Houston, TX',
    website: 'https://actonheights.com',
    schoolModel: 'Acton learner-driven affiliate campus — mixed-age, Montessori-influenced with Socratic method and self-paced mastery',
    grades: 'Elementary Studio (ages 5–11)',
    estimatedSize: 'Small microschool-scale',
    tuitionSchedule: '$20,000 + $1,000 registration/supply fee/year; M–F 8am–3pm; nine months/year with ~6-week sessions',
    strengths: [
  ...
  {
    id: 'primer-live-oak',
    name: 'Primer Microschools — Live Oak',
    state: 'TX',
    location: 'San Antonio, TX',
    website: 'https://primer.com/schools/live-oak-tx',
    schoolModel: 'Teacher-led K–8 microschool with small mixed-age classrooms, foundations-first academics, and project-based Pursuits; part of the Primer network',
    grades: 'K–8',
    estimatedSize: 'Small campus; 3–6 mixed-age classrooms typical',
    tuitionSchedule: 'Free via Texas Education Freedom Accounts; small after-school cost; opening Aug 2026',
    strengths: [
  ...
  {
    id: 'cosmic-roots-nature-school',
    name: 'Cosmic Roots Nature School',
    state: 'TX',
    location: 'Georgetown, TX',
    website: 'https://www.cosmicrootsgeorgetown.org',
    schoolModel: 'Nature-based, Montessori/Reggio/Waldorf-inspired private microschool with hybrid high school dual-credit option',
    grades: 'Ages 3–15; PreK–8 (9th planned)',
    estimatedSize: '~55 students',
    tuitionSchedule: '$850/month elementary; $785/month HS dual-credit hybrid; Mon–Thu 9am–3pm + aftercare until 6pm',
    strengths: [
  ...
  {
    id: 'primer-university-heights',
    name: 'Primer Microschools — University Heights',
    state: 'TX',
    location: 'San Antonio, TX',
    website: 'https://primer.com/schools/university-heights-tx',
    schoolModel: 'Teacher-led, mixed-age K–8 microschool; one-room-schoolhouse-inspired, with core instruction plus project-based learning blocks; part of the Primer network',
    grades: 'K–8',
    estimatedSize: '3–6 mixed-age classrooms; network has ~48 schools across ~20 locations',
    tuitionSchedule: 'Free via Texas Education Freedom Accounts; opening Aug 2026; rolling enrollment/open admissions',
    strengths: [
  ...
  {
    id: 'acton-academy-nw-austin',
    name: 'Acton Academy Northwest Austin',
    state: 'TX',
    location: 'Austin, TX',
    website: 'https://www.actonacademynwaustin.org',
    schoolModel: 'Independent Acton Academy campus — learner-driven, network-affiliated microschool using the Hero Journey philosophy',
    grades: 'Ages 4–12',
    estimatedSize: '~22 students',
    tuitionSchedule: 'Tuition not published; admissions via 20-min call + 30-min Pop-In Tour',
    strengths: [
  ...
  {
    id: 'masterpiece-academy',
    name: 'Masterpiece: An Acton Academy',
    state: 'TX',
    location: 'Pearland, TX',
    website: 'https://www.masterpieceacademy.org',
    schoolModel: 'Acton Academy-style learner-driven microschool — Montessori-inspired, Socratic, hands-on, faith-based, mixed-age, independent affiliate',
    grades: 'Ages 4–11 (PreK–5th); expanding to ages 11–18',
    estimatedSize: 'Small; no public enrollment count',
    tuitionSchedule: 'Tuition not publicly stated; August–May calendar',
    strengths: [
  ...
  {
    id: 'brazos-valley-honor-academy',
    name: 'Brazos Valley Honor Academy',
    state: 'TX',
    location: 'Navasota, TX',
    website: 'https://mybvha.com',
    schoolModel: 'Christian homeschool/private-school hybrid environment; parent-partnered, multi-day campus program',
    grades: 'K–7',
    estimatedSize: 'Small; likely under 100 students',
    tuitionSchedule: '$475/month (Sept–May); $100 enrollment fee + $350 curriculum/technology fee; Tue–Thu 8:30am–3:30pm',
    strengths: [
  ...
  {
    id: 'deep-waters-academy',
    name: 'Deep Waters Academy',
    state: 'TX',
    location: 'Webster (Clear Lake), TX',
    website: 'https://www.deepwatersacademy.org',
    schoolModel: 'University-Model® hybrid school — classical Christian, parent-partnered homeschool/private-school blend',
    grades: 'K–10 (adding a grade each year)',
    estimatedSize: 'Small-to-mid; likely under 100 students',
    tuitionSchedule: 'Tuition not public; Mon & Wed 8:30am–3:30pm on campus; home days with parent co-teacher; $100 annual application fee',
    strengths: [
  ...
  {
    id: 'bluebonnet-home-scholars',
    name: 'Bluebonnet Home Scholars Collaborative',
    state: 'TX',
    location: 'Sugar Land, TX',
    website: 'https://www.bluebonnetscholars.org',
    schoolModel: 'Christian liberal arts homeschool support program — group class community, parent-partnership model, à-la-carte classes plus full-program options, drop-off style',
    grades: 'K–12 (Forms I–IV)',
    estimatedSize: 'Multi-family; multiple forms and instructors',
    tuitionSchedule: '31 weeks/year; primarily Tue/Fri with some Thu; class fees vary (e.g. $94 packet + $395/yr volunteer buy-out)',
    strengths: [
    ...
    priorityScore: 4,
    confidence: 'High model; Medium size',
    sourceFile: 'expanded',
  },
  {
    id: 'luff-learning',
    name: 'Luff Learning Fine Arts Academy',
    state: 'TX',
    location: 'Spring, TX',
    website: 'https://lufflearning.org',
    schoolModel: 'Hybrid homeschool-style private school with a fine arts focus; arts-integrated instruction, tutoring options, and part-time program blocks',
    grades: 'Ages 5–18',
    estimatedSize: 'Small; waitlist for Fine Arts Friday indicates limited capacity',
    tuitionSchedule: 'Tuition not published; Mon/Wed (CCC) 9:30am–2:30pm; Tue/Thu/Fri (AEP) 9:30am–2:30pm',
    strengths: [
  ...
  {
    id: 'heart-of-christ-academy',
    name: 'Heart of Christ Academy',
    state: 'TX',
    location: 'Cypress, TX',
    website: 'https://www.heartchristianacademy.org',
    schoolModel: 'Hybrid homeschool / university-model school — 2 days on campus + 3 days at home; Christian learning center model',
    grades: 'PreK–12',
    estimatedSize: '~43–46 students; 9:1 student-teacher ratio',
    tuitionSchedule: '$4,000 (K–4) and $4,500 (5–8)/year; 2 days on campus + 3 days home',
    strengths: [
  ...
  {
    id: 'meadow-creek-academy',
    name: 'Meadow Creek Academy (fmr. Forest Path Academy)',
    state: 'TX',
    location: 'Alvin, TX',
    website: 'https://www.meadowcreekacademy.com',
    schoolModel: 'Homeschool-inspired hybrid school with small classes, STEAM Mondays, 3-day academic, and 4-day complete options; nature-based and hands-on learning emphasis',
    grades: 'PreK–12',
    estimatedSize: 'Small; spots limited and small-class language used throughout',
    tuitionSchedule: 'STEAM Mondays $1,955/yr; 3-Day Academic $5,450/yr; 4-Day Complete $6,395/yr; Mon–Thu schedules + electives',
    strengths: [
  ...
  {
    id: 'rise-hybrid-private-academy',
    name: 'RISE Hybrid Private Academy',
    state: 'MD',
    location: 'Beaumont, TX (admin office); Olney, MD (HQ)',
    website: 'https://www.risehybridacademy.com',
    schoolModel: 'Hybrid private school with personalized, individualized, online-plus-in-person learning; not a homeschool co-op; serves students nationwide',
    grades: 'K–12',
    estimatedSize: 'Small; avg class size of 6',
    tuitionSchedule: '~$20,000/year online; ~$22,000/year in-person; $600 summer; rolling admissions via FACTS',
    strengths: [
  ...
  {
    id: 'ellemercito-academy',
    name: 'Ellemercito Academy / Ellemercito Learning Community',
    state: 'CA',
    location: 'Downey, CA',
    website: 'https://ellemercito.org',
    schoolModel: 'Independent microschool with hybrid homeschool model — project-based, place-based, trauma-informed, experiential, and learner-centered, with mixed-age or flexible-grade instruction',
    grades: 'K–12',
    estimatedSize: '~20–50 students',
    tuitionSchedule: '$100/week (1 day), $200/week (2 days), $300/week (3 days); community membership $190/month; Mon–Wed 8:15am–2:15pm core',
    strengths: [
  ...
  {
    id: 'true-north-the-woodlands',
    name: 'True North Parent Partnership',
    state: 'TX',
    location: 'The Woodlands, TX',
    website: 'https://truenortheducation.weebly.com',
    schoolModel: 'Hybrid parent-partnership program with on-site classes and enrichment — Christian, biblically based; closer to a homeschool learning center / hybrid microschool than a traditional private school',
    grades: '1–12',
    estimatedSize: 'Small; multiple grade bands with a limited instructor roster',
    tuitionSchedule: 'Tuition not clearly posted; advertised as an affordable alternative to public/private school',
    strengths: [
  ...
  {
    id: 'wondering-oaks-learning',
    name: 'Wondering Oaks Learning',
    state: 'TX',
    location: 'Conroe/Willis, TX',
    website: 'https://www.wonderingoakslearning.com',
    schoolModel: 'Homeschool-away-from-home microschool — multi-age, part-time/full-time secular program bridging homeschool and private school',
    grades: 'TK–3rd grade (ages 5–8)',
    estimatedSize: '~10 students per class',
    tuitionSchedule: 'Tuition not published; Mon–Thu year-round in 4–6 week cycles with 1-week breaks',
    strengths: [
  ...
  {
    id: 'one-acre-farm',
    name: 'One Acre Farm Farm School Learning Pod',
    state: 'TX',
    location: 'Porter, TX',
    website: 'https://oneacrefarmtx.com',
    schoolModel: 'Nonprofit educational farm with two outdoor Farm School Learning Pods — supplemental homeschool learning, not a full-day accredited school',
    grades: 'Early Childhood ages 4–6; Elementary ages 7–10',
    estimatedSize: 'Small; two outdoor pods; enrollment size not stated',
    tuitionSchedule: 'Elementary pod: $325/month (2 days/week) or $180/month (1 day/week); Wed or Thu 8am–1pm',
    strengths: [
  ...
  {
    id: 'play-full-ground',
    name: 'Play Full Ground',
    state: 'CA',
    location: 'Monterey, CA',
    website: 'https://www.playfullground.com',
    schoolModel: 'Creative micro high school community — hybrid-style microschool with independent learning, project-based studio classes, and weekly reflection/community share',
    grades: 'High School',
    estimatedSize: 'Very small (1 employee listed on LinkedIn)',
    tuitionSchedule: 'Tuition not listed; full-time and part-time options; morning independent study + afternoon creative classes + Friday community share',
    strengths: [
  ...
  {
    id: 'home-education-partnership',
    name: 'Home Education Partnership of Texas (HEP TX)',
    state: 'TX',
    location: 'Friendswood, TX',
    website: 'https://heptx.com',
    schoolModel: 'Classical School + college-preparatory University Model hybrid — parent-partner program with on-campus classes once or twice weekly and at-home instruction on alternate days',
    grades: 'PreK 3 – 12th grade',
    estimatedSize: 'Established and sizable for Houston homeschool market; 27+ years operating',
    tuitionSchedule: 'Classes 1–2x/week; PreK Wed; K–5 Mon/Wed or Tue/Thu; 6–12 Mon–Thu; $35 app + $125 reg + $150 course deposit per class',
    strengths: [
  ...
  {
    id: 'south-oc-hybrid-homeschool',
    name: 'South OC Hybrid Homeschool (SOCHH)',
    state: 'CA',
    location: 'Mission Viejo, CA',
    website: 'https://southochybridhomeschool.com',
    schoolModel: 'Private nonprofit hybrid homeschool learning center — drop-off classes with 1–5 day options, parent partnership, and charter-vendor acceptance',
    grades: '1st–8th grade; TK option available',
    estimatedSize: 'Small-to-midsize nonprofit',
    tuitionSchedule: '1–5 days/week; Mon Arts & Innovations; Tue–Thu CORE + extended care; Fri LEAPS; tuition not publicly posted',
    strengths: [
  ...
  {
    id: 'courage-lab-academy',
    name: 'Courage Lab Academy',
    state: 'CA',
    location: 'Whittier, CA',
    website: 'https://www.couragelab.academy',
    schoolModel: 'Faith-integrated microschool blending homeschooling, private school, and innovative learning models — mastery-based, self-paced, multi-age, discussion/project-oriented',
    grades: 'K–5',
    estimatedSize: 'Small; 12:1 student-guide ratio',
    tuitionSchedule: 'Tuition not publicly stated; schedule not stated; family-first flexibility emphasized',
    strengths: [
  ...
  {
    id: 'inner-fire-academy',
    name: 'Inner Fire Academy',
    state: 'CA',
    location: 'San Francisco, CA',
    website: 'https://innerfiresf.com',
    schoolModel: 'Teacher-owned, teacher-led microschool for gifted and neurodivergent learners',
    grades: 'K–5 (ages 5–12)',
    estimatedSize: '8 students per class; 6:1 student-to-staff ratio',
    tuitionSchedule: '$38,500 (K–2 full-time); $42,500 (3–5 full-time); $215/day part-time; billed monthly',
    strengths: [
    ...
    priorityScore: 4,
    confidence: 'High classification; Medium location precision',
    sourceFile: 'expanded',
  },
  {
    id: 'praxis-elite-sports-academy',
    name: 'Praxis Elite Sports Academy Junior Prep',
    state: 'CA',
    location: 'San Diego, CA',
    website: 'https://www.praxiselite.com',
    schoolModel: 'Hybrid-ish microschool for student-athletes — combines academics and athletics with part-time and full-time options, Friday recovery/personal development, and individualized curriculum',
    grades: '7–8 (6th grade considered case-by-case)',
    estimatedSize: 'Small; limited spots and small mixed-age groups',
    tuitionSchedule: '5-day $21,500/year; 3-day $16,500/year; Enrichment Fri $750/month; Mon–Thu 9am–3:45pm',
    strengths: [
  ...
  {
    id: 'kings-academy-vineyard',
    name: "King's Academy Vineyard — Laguna Niguel",
    state: 'CA',
    location: 'Laguna Niguel, CA',
    website: 'https://www.vineyardln.com/kings-academy',
    schoolModel: 'Church-based homeschool ministry and hybrid drop-off program — parents are primary educators at home on non-campus days; staff teach on campus three days per week',
    grades: 'K–12',
    estimatedSize: 'Small; avg class size of 16; likely under 100 students',
    tuitionSchedule: 'Tuition not listed; Tue–Thu 9am–3:30pm on campus; home learning Mon/Fri',
    strengths: [
    ...
    priorityScore: 4,
    confidence: 'High active program; Medium size/tuition',
    sourceFile: 'expanded',
  },
  {
    id: 'apogee-la',
    name: 'Apogee LA Microschool',
    state: 'CA',
    location: 'Los Angeles, CA',
    website: 'https://apogeela.com',
    schoolModel: 'Faith-based, values-driven microschool with project-based, student-led learning, mentorship, leadership development, movement/martial arts, and outdoor learning',
    grades: 'Not clearly stated',
    estimatedSize: 'Small',
    tuitionSchedule: 'Not publicly listed; families schedule a tour for details',
    strengths: [
  ...
  {
    id: 'acton-academy-placer',
    name: 'Acton Academy Placer',
    state: 'CA',
    location: 'Roseville, CA',
    website: 'https://actonplacer.com',
    schoolModel: 'Acton Academy learner-driven, multi-age, self-paced private school with a hybrid program option; part of the broader Acton Academy network',
    grades: 'TK–12 (Spark 4–7, Threshold 7–11, Discovery 11–14, Launchpad 14–18)',
    estimatedSize: 'Small-to-medium (2–10 employees); additional campuses in Sacramento and Rocklin',
    tuitionSchedule: '$11,500 TK–8; $13,500 9–12; 11-month calendar; Hybrid Program launching Fall 2025',
    strengths: [
    ...
    priorityScore: 5,
    confidence: 'High active private Acton campus; Medium size',
    sourceFile: 'expanded',
  },
  {
    id: 'sonoma-earth-school',
    name: 'Sonoma Earth School',
    state: 'CA',
    location: 'Forestville, CA',
    website: 'https://www.earthschool.org',
    schoolModel: 'Nature-based, mixed-age, dual-language (Spanish/English), place-based experiential K–8 school with individualized academics',
    grades: 'K–8',
    estimatedSize: '~29 students',
    tuitionSchedule: 'Tiered annual tuition by AGI: K $10,200–$15,000; 1st–8th $15,000–$21,000; monthly payment options; now enrolling 2025–26',
    strengths: [
    ...
    softwareFitReason:
      'Strong fit: small private K–8 outdoor program with individualized learning, mixed-age groups, admissions steps, tiered tuition tiers, and likely high-touch family communication needs.',
    priorityScore: 4,
    confidence: 'High model; Medium social/reputation',
    sourceFile: 'expanded',
  },
  {
    id: 'wild-hearts-adventure',
    name: 'Wild Hearts Adventure Co.',
    state: 'CA',
    location: 'Visalia, CA',
    website: 'https://wildheartsadventure.co',
    schoolModel: 'Self-directed, project-based, nature-based twice-weekly learning community; separate middle/high-school program called True North',
    grades: 'TK–12 (Wild Hearts TK–2nd; True North 6–12)',
    estimatedSize: 'Small group; exact enrollment not stated',
    tuitionSchedule: 'Wild Hearts $350/month (twice weekly); True North $300/month (two days choice); charter enrichment funds accepted',
    strengths: [
    ...
    priorityScore: 4,
    confidence: 'High model; Medium size/social',
    sourceFile: 'expanded',
  },
  {
    id: 'foothill-christian-academy',
    name: 'Foothill Christian Academy',
    state: 'CA',
    location: 'Upland, CA',
    website: 'https://www.foothillchristianacademy.com',
    schoolModel: 'Hybrid homeschool / Private School Satellite Program (PSP) with significant parent involvement; Mon/Fri at home, Tue/Wed on campus, Thu half-day on campus',
    grades: 'K–7 (TK–8 in practice)',
    estimatedSize: 'Small; rolling admissions with limited class space',
    tuitionSchedule: '$4,774/year + $50 application fee; Mon/Fri home, Tue/Wed campus, Thu half-day campus',
    strengths: [
  ...
  {
    id: 'the-lab-learning-space',
    name: 'The Lab Learning Space',
    state: 'CA',
    location: 'Long Beach, CA',
    website: 'https://www.lablearning.org',
    schoolModel: 'Hybrid homeschool learning center with mastery-based, project-based, personalized tutoring and enrichment — explicitly modeled on Khan Lab School concepts; serves homeschool/charter families',
    grades: 'K–8',
    estimatedSize: 'Very small (2–10 employees)',
    tuitionSchedule: 'WOW! 2-day enrichment $2,000/semester; à la carte ~$1,000/semester; PE $200/month; 9am–3pm or 8:30am–5pm',
    strengths: [
  ...
  },
  {
    ...
    website: 'https://www.teachoutside.org',
    schoolModel: '100% outdoor, mixed-age, tiny-group forest school for hybrid, homeschool, and independent-school families',
    grades: 'K–12 (ages 5–18)',
    estimatedSize: 'Max 8 school-age children',
    tuitionSchedule: 'Tuition not publicly shown; Tue–Thu 9am–3pm',
    strengths: [
  ...
  {
    id: 'terra-marin-schools',
    name: 'Terra Marin Schools / Terra Schools',
    state: 'CA',
    location: 'Mill Valley, CA',
    website: 'https://www.terraschools.org',
    schoolModel: 'Nature-based, multilingual private school with Mandarin immersion preschool/TK, on-campus K–8, and a full-time outdoor micro-school component; Reggio Emilia-inspired',
    grades: 'Preschool – 8th grade',
    estimatedSize: '~112 students',
    tuitionSchedule: '~$36,975/year (Niche); rolling admissions; expanding one grade per year',
    strengths: [
  ...
  {
    id: 'slo-classical-academy',
    name: 'San Luis Obispo Classical Academy',
    state: 'CA',
    location: 'San Luis Obispo, CA',
    website: 'https://sloclassical.org',
    schoolModel: 'Classical education school with full-time and two-day hybrid programs; not a pure microschool but has a homeschool-like hybrid component and parent-partner model',
    grades: 'Infant – 12th grade',
    estimatedSize: '~372–406 students',
    tuitionSchedule: 'Five-day full-time, two-day hybrid, and Friday program options; tuition not clearly posted on homepage',
    strengths: [
  ...
  {
    id: 'adelphia-classical-christian',
    name: 'Adelphia Classical Christian Academy',
    state: 'CA',
    location: 'Orange, CA',
    website: 'https://www.adelphiaclassical.com',
    schoolModel: '3-day on-campus, teacher-led hybrid/private school program with at-home work on two weekdays; fits a microschool/hybrid homeschool model more than a traditional school; PSP',
    grades: 'K–12',
    estimatedSize: 'Small; class size normally limited to 16; some grades combined',
    tuitionSchedule: 'Three days on campus (Mon/Tue/Thu); at-home learning Wed and Fri; specific tuition amounts not visible in sources reviewed',
    strengths: [
    ...
    priorityScore: 4,
    confidence: 'High hybrid microschool-style; Medium tuition',
    sourceFile: 'expanded',
  },
  {
    id: 'monarch-hills-education',
    name: 'Monarch Hills Education',
    state: 'CA',
    location: 'San Luis Obispo, CA',
    website: 'https://www.monarchhills.org',
    schoolModel: 'Nature-based outdoor enrichment and alternative education program — hybrid homeschool-style microschool serving homeschool families with full-time and part-time attendance options',
    grades: 'TK–6',
    estimatedSize: 'Small; family-sized based on program format',
    tuitionSchedule: '5-day $9,000/yr; 4-day $8,000/yr; 3-day $6,750/yr; 2-day $4,500/yr; 1-day $2,300/yr; Mon–Fri 8:30am–2:30pm; off-site adventure Fridays',
    strengths: [
  ...
  {
    id: 'blue-horizon-studio',
    name: 'Blue Horizon Studio',
    state: 'CA',
    location: 'Lathrop, CA',
    website: 'https://www.bluehorizonstudio.org',
    schoolModel: 'Boutique microschool with a studio/residency-style model — expert-led daytime academics, self-directed projects, and flexible attendance for homeschool/charter families',
    grades: '3–8',
    estimatedSize: 'Boutique cohort of 14',
    tuitionSchedule: 'Published tuition not found; flexible access 7am–6pm; soft start 7–9am; core focus 9am–12:30pm; studio time 2:30–6pm',
    strengths: [
    ...
    priorityScore: 4,
    confidence: 'High real private microschool; Medium size/tuition',
    sourceFile: 'expanded',
  },
  {
    id: 'integrity-christian-school',
    name: 'Integrity Christian School PSP',
    state: 'CA',
    location: 'Anaheim, CA',
    website: 'https://www.integritychristianschool.org',
    schoolModel: 'Hybrid homeschool community / PSP-style private school satellite program — two on-campus instruction days per week and three days at home',
    grades: 'K–12',
    estimatedSize: '~137–160 students',
    tuitionSchedule: 'New student reg $250; returning $235; family tuition $375/yr; class-based $250–$425/class; Tue & Thu 9am–3pm/4pm on campus',
    strengths: [
    ...
    priorityScore: 4,
    confidence: 'High active; Medium size (third-party directories)',
    sourceFile: 'expanded',
  },
]
