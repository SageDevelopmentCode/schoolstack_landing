...
type AdminMessagesStoryHeaderProps = {
  searchQuery: string;
...
export function AdminMessagesStoryHeader({
  searchQuery,
  onSearchChange,
  onNewMessage,
  newMessageDisabled = false,
}: AdminMessagesStoryHeaderProps) {
  ...
  return (
    <View
      ...
      testID="admin-messages-inbox-header">
      <View style={styles.titleRow}>
        ...
        <Pressable
          ...
          testID="admin-messages-new-button"
          style={({ pressed }) => [
            styles.newButton,
            {
