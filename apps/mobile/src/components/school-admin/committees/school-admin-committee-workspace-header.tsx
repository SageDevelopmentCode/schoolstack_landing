...
type SchoolAdminCommitteeWorkspaceHeaderProps = {
  committee: Committee;
  activeSection: CommitteeWorkspaceSection;
  onSectionChange: (section: CommitteeWorkspaceSection) => void;
};

export function SchoolAdminCommitteeWorkspaceHeader({
  committee,
  activeSection,
  onSectionChange,
}: SchoolAdminCommitteeWorkspaceHeaderProps) {
  ...
  const navItems = sections.map((section) => ({
    ...
    testID: `school-admin-committee-section-${section}`,
  }));
      ...
      <View style={[styles.container, { backgroundColor: theme.white, borderBottomColor: theme.line }]}>
        <View style={styles.inner}>
          <Pressable
            ...
            <Text style={[styles.backLabel, { color: theme.muted }]}>Committees</Text>
          </Pressable>
